...
def mailing(cause, to, kod):
    ...
    if cause == "reg":
        ...
        {kod}\nна нашем сайте или перейди по ссылке:\nhttp://gamepyed.herokuapp.com//checkemail/key={kod}\n
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr style="border-collapse:collapse;">
                                                                    <td class="es-m-txt-c" align="center"
                                                                        ...
                                                                        <a href="http://gamepyed.herokuapp.com/" target="_blank"
                                                            ...
                                                            <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#FFFFFF;"
                                                                    ...
                                                                    <td class="es-m-txt-c" align="center"
                                                                        ...
                                                                        <span class="es-button-border"
                                                                              style="border-style:solid;border-color:#453163;background:#453163;border-width:1px;display:inline-block;border-radius:2px;width:auto;"><a
                                                                                href="http://gamepyed.herokuapp.com//checkemail/key=''' + kod + '''"
                                                                ...
                                                                <tr style="border-collapse:collapse;">
                                                                    <td class="es-m-txt-c" align="center"
                                                                        ...
                                                                        <a target="_blank"
                                                                           href="http://gamepyed.herokuapp.com//checkemail/key=''' + kod + '''"
                                                                           style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;font-size:18px;text-decoration:underline;color:#453163;">http://gamepyed.herokuapp.com//checkemail/key=''' + kod + '''</a>
                                                                    </td>
                                                                </tr>
                                                                <tr style="border-collapse:collapse;">
                                                                    <td class="es-m-txt-c" align="center"
                                                                ...
                                                                <tr style="border-collapse:collapse;">
                                                                    <td class="es-m-txt-c" align="center"
                                                                        style="padding:0;Margin:0;font-size:0px;"><a
                                                                            target="_blank" href="http://gamepyed.herokuapp.com//"
